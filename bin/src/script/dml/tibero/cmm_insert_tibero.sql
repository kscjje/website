...
INSERT INTO COMTCCMMNCLCODE(CL_CODE, CL_CODE_NM, CL_CODE_DC, USE_AT, FRST_REGIST_PNTTM, FRST_REGISTER_ID, LAST_UPDT_PNTTM, LAST_UPDUSR_ID) VALUES ('HIS', '사이트 공통코드', '사이트 공통코드', 'Y', SYSDATE, 'SYSTEM', SYSDATE, 'SYSTEM');
...
INSERT INTO COMTNAUTHORINFO VALUES ('ROLE_SUPER'                   ,'슈퍼 관리자'           , '', SYSDATE);
...
INSERT INTO COMTNROLES_HIERARCHY VALUES ('ROLE_ADMIN'                    ,'ROLE_SUPER');

/* 롤정보 */
INSERT INTO COMTNROLEINFO (ROLE_CODE, ROLE_NM, ROLE_PTTRN, ROLE_DC, ROLE_TY, ROLE_SORT, ROLE_CREAT_DE) VALUES('web-000001', '로그인롤', '\A/nsmadm/(login|actionMain|actionLogin)\Z', '로그인허용을 위한 롤', 'url', '1', SYSDATE);
INSERT INTO COMTNROLEINFO (ROLE_CODE, ROLE_NM, ROLE_PTTRN, ROLE_DC, ROLE_TY, ROLE_SORT, ROLE_CREAT_DE) VALUES('web-000002', '관리 모든 업무(슈퍼관리자)', '\A/nsmadm/.*/.*\Z', '슈퍼관리자 권한', 'url', '2', SYSDATE);
INSERT INTO COMTNROLEINFO (ROLE_CODE, ROLE_NM, ROLE_PTTRN, ROLE_DC, ROLE_TY, ROLE_SORT, ROLE_CREAT_DE) VALUES('web-000003', '사용자 페이지', '\A/nsm/.*\Z', '사용자 페이지 권한', 'url', '1', SYSDATE);


/* 권한롤관계 */
INSERT INTO COMTNAUTHORROLERELATE (AUTHOR_CODE, ROLE_CODE, CREAT_DT) VALUES ('ROLE_ANONYMOUS', 'web-000001', SYSDATE);
INSERT INTO COMTNAUTHORROLERELATE (AUTHOR_CODE, ROLE_CODE, CREAT_DT) VALUES ('ROLE_SUPER', 'web-000002', SYSDATE);
INSERT INTO COMTNAUTHORROLERELATE (AUTHOR_CODE, ROLE_CODE, CREAT_DT) VALUES ('ROLE_ANONYMOUS', 'web-000003', SYSDATE);
...
/* 메뉴 디폴트 */
INSERT INTO COMTNMENUINFO (SITE_GUBUN,MENU_NO,MENU_NM,UPPER_MENU_NO, MENU_ORDR) VALUES ('ADMIN', 1 , '모든 메뉴' , 0 , 0);

/* 메뉴 디폴트 */
INSERT INTO COMTNMENUCREATDTLS (MENU_NO,AUTHOR_CODE,INS_YN,UPD_YN,DEL_YN) VALUES (1, 'ROLE_SUPER' , 'Y' , 'Y' , 'Y');
