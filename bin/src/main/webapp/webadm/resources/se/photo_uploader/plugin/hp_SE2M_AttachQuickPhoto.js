...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_SET_PHOTO : function(aPhotoData){
		...
		try{
			...
			for(var i = 0; i <aPhotoData.length; i++){				
				...
				if (htData.sFileWidth) {
					aWidth = "width="+htData.sFileWidth;
				}
				
				if (htData.sFileHeight) {
					aHeight = "height="+htData.sFileHeight;
				}				
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" title="{=sName}" {=sWidth} {=sHeight}>';
