	...
	var welUploadInputBox = $Element("file_1");
	 ...
	 */
     function goStartMode(){
    	 ...
    	 console.log("goStartMode :: src = " + sSrc);
     ...
     */
 	function readyModeBG (){
 		...
 		console.log("readyModeBG = " + sClass);
 	...
 	function startModeBG (){
 		...
 		console.log("startModeBG = " + sClass);
	...
	//--------------------- html5  지원되는 브라우저에서 사용하는 함수  --------------------------
 	...
 	function updateViewCount (nCount, nVariable){
 		...
 		console.log("updateViewCount = " + nCnt);
 	...
 	function updateViewTotalSize(){
 		...
 		console.log("updateViewTotalSize()");
 	...
 	function refreshTotalImageSize(sParentId){
 		...
 		console.log("refreshTotalImageSize() " + sParentId);
 	...
 	function removeImageInfo (sParentId){
 		...
 		console.log("removeImageInfo() " + sParentId);
 	...
 	function setUnitString (nByte) {
 		...
 		console.log("setUnitString() :: " + nByte);
 	...
 	function cuttingNameByLength (sName, nMaxLng) {
 		...
 		console.log("cuttingNameByLength() :: " + sName + " : " + nMaxLng);
 	...
 	function checkTotalImageSize(nByte){
 		...
 		console.log("checkTotalImageSize() :: " + nByte);
    ...
    function html5Upload() {
    	...
    	alert("call [attach_photo.js] html5Upload()");

    	//sUploadURL= 'file_uploader_html5.php'; 	//upload URL
 		sUploadURL= '../../../../../webadm/seditor2/imageUpload'; //upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		...
 		uploadURL = uploadURL.split("/resources")[0];

 		oFileUploader = new jindo.FileUploader(jindo.$("file_1"),{
 			//sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
 			sUrl  : uploadURL + '/seditor2/imageUpload',
 	        sCallback : location.pathname.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 	    	...
 	    	select : function(oCustomEvent) {
 	    		...
 	    		console.log("call callFileUploader :: attach :: select() ");
...
// 	    		oCustomEvent.stop(); 수행시 bAllowed 가 false이더라도 alert이 수행되지 않음
 	    	...
 	    	success : function(oCustomEvent) {
 	    		...
 	    		console.log("call callFileUploader :: attach :: success() ");
 	    	...
 	    	error : function(oCustomEvent) {
 	    		...
 	    		console.log("call callFileUploader :: attach :: error() ");
