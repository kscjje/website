 ...
 */
        ...
        jQuery.fn.showLoading = function(options) {
                ...
                var loadingDiv = jQuery('<div style="width:150px;height:150px;background-color:#FFFFFF;border-radius: 10px;;text-align:center;"><img src="'+ajaxLoadingImg+'" alt="로딩이미지" style="width:100px;height:100px;margin-top:10px;"><p>처리 중입니다.</p></div>');
