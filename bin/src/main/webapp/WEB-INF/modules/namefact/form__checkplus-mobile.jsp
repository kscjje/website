...
System.out.println("checkplus_mobile_response_success = " + checkplus_mobile_response_success);
System.out.println("checkplus_mobile_response_fail    = " + checkplus_mobile_response_fail);
...
<script>
	//alert("${namefactModuleInfo.properties.checkplus_mobile_request}");
	//alert("${param.mode}");
</script>
	...
	<c:when test="${param.mode == 'mobile'}">
		<form id="CHECKPLUS_MOBILE_namefact_form" method="post" action="<c:out value='${namefactModuleInfo.properties.checkplus_mobile_request}'/>">
			<fieldset>
				...
				<input type="text" name="EncodeData" value="<%=sEncData%>"/>
				<input type="text" name="m" value="checkplusSerivce"/>
			...
			<c:when test="${param.mode == 'button'}">
				<form id="CHECKPLUS_MOBILE_namefact_form" class="${namefact_count == 1 ? 'single' : ''}" target="CHECKPLUS_MOBILE_namefact_window" method="post" action="<c:out value="${namefactModuleInfo.properties.checkplus_mobile_request}"/>">
					<fieldset>
						...
						<input type="hidden"   name="param_r2" value=""/>
						<input type="hidden"   name="param_r3" value=""/>
						<input type="hidden"   name="param_r4" value="myConfirmCerti"/>
