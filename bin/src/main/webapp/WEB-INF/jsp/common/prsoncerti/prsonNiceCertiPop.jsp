...
String checkplus_mobile_response_success = "/web/common/prsoncerti/successPop";
String checkplus_mobile_response_fail    = "/web/common/prsoncerti/failPop";
...
<c:choose>
	...
	<c:when test="${param.mode == 'mobile'}">
		<form id="CHECKPLUS_MOBILE_namefact_form" method="post" action="https://nice.checkplus.co.kr/CheckPlusSafeModel/checkplus.cb">
			<fieldset>
				<legend>휴대전화 본인인증</legend>
				
				<input type="hidden" name="EncodeData" value="<%=sEncData%>"/>
				<input type="hidden" name="m" value="checkplusSerivce"/>
				<input type="hidden" name="param_r1" value="mineCerti"/>
		...
		<script type="text/javascript">
			...
			jQuery(document).ready(function() {
				...
				var varMyInputUserId = sessionStorage.getItem("inputVal");
				$('input[name=param_r2]').val(varMyInputUserId);			
