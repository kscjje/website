			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td class="b">
							<input type="radio" class="radio" name="r" id="fChk1" checked /><em></em>&nbsp;<label for="fChk1">비공개</label>
							&nbsp;&nbsp;&nbsp;<input type="radio" class="radio" name="r" id="fChk2" /><em></em>&nbsp;<label for="fChk2">공개</label>
						</td>
					</tr>
					<tr>
