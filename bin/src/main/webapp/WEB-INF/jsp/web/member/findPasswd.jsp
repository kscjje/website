...
<main class="content" id="content">
      ...
      <div class="subVisual">
        <div class="subVisual-inner">
          ...
          <h3 class="subVisual-title position-absolute start-50 top-50 translate-middle">비밀번호 찾기</h3>
        </div>
      </div>
      <div class="pageTit">
        <div class="pageTit-inner">
          <div class="pageTit-wrap">
            <h3 class="pageTit-title">비밀번호 찾기</h3>
            <ul class="pageTit-list">
              ...
              <li class="pageTit-item">
                <a href="javascript:void(0)" title="이동" class="pageTit-link">비밀번호 찾기</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="joinMember-inner">
            <div class="joinMember-wrap">
              <div class="joinMember-top">
                <h3 class="joinMember-title">비밀번호를 잊으셨나요?</h3>
                <p class="joinMember-txt mt-4">아래의 모든 정보를 입력해 주시면 비밀번호 찾기가 가능합니다.</p>
                <ul class="joinMember-list">
                
                  <li class="joinMember-item">
                  
                   <form name="memberVO" id="memberVO" method="post" action="./findPasswdCheck">
                  ...
                  <div class="joinMember-box" style="padding:16px 0">
                  	<p class="login-txt">가입시 등록한 정보로 비밀번호를 찾을 수 있습니다.</p>
					<br/>
                  	
					<div class="login-box w_box ">
		                <div class="login-conbox w400" style="margin: 10px auto 0;">
		                  <div class="input-group">
		                    <label for="inp09_06_01" class="visually-hidden"></label>
		                    <input type="text" id="idText" name="id" class="inp02_box w400" placeholder="아이디">
		                  </div>
		                  <div class="input-group">
		                    <label for="inp09_06_01" class="visually-hidden"></label>
                  ...
                  <button type="button" class="btn btn-badge green w-100 mt-4" onclick="findPasswdCheck();">비밀번호 찾기</button>
                  </li>                  
