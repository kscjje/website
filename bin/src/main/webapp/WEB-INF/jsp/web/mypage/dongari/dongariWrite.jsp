				...
				<div class="table t_table t_flex">
					...
					<table>
						...
						<tbody>
							...
							<tr>
								<th scope="row" class="vtop"><span>모임주소 입력 <em class="star">*</em></span></th>
								<td>
							...
							<tr>
								<th scope="row" class="vtop">동아리 소개글<em class="star">*</em></th>
								<td>
							...
							<tr>
								...
								<td>
						        	<c:import url="/web/common/upload/includeUploadDongari" >
