...
<%
  ...
  * @Description : 강연/행사/영화 예약 목록 페이지
	...
	<form:hidden path="gubun" />
		<div class="m_table m_table2 mb20 ty">
						...
						<div class="m_table m_table2 ty mb20">
							<table>
								<caption>강연/행사/영화 예약 신청현황 게시판</caption>
								<thead>
									<tr>
										<th class="number">번호</th>
										<th class="numdt">예약번호/예약일자</th>
										<th class="">강연/행사/영화 예약/관람일자</th>
												...
												<c:choose>
													<c:when test="${var.interStatus eq 'ING'}">
														...
														<c:if test="${var.evtRsvnApptype eq '20'}">
															<button type="button" class="btn_ty_s2_c2" onclick="javascript:fn_waiting_cancel('EVT' , '<c:out value="${var.evtRsvnIdx}"/>')">신청취소</button>	
														</c:if>
						...
						<table>
							...
							<thead>
								<tr>
									...
									<th class="numdt">예약번호/예약일자</th>
									<th class="pro">강연/행사/영화  예약/관람일자</th>
							...
							<c:forEach items="${list }" var="var" varStatus="s">
								<tr>
									...
									<td class="cancel"><button type="button" class="btn_ty_s2_c2" onclick="javascript:fn_waiting_cancel('EVT' , '<c:out value="${var.evtRsvnIdx}"/>')">예약취소</button></td>
								</tr>
							</c:forEach>
							</tbody>
						</table>						
...
<script>
	...
	function fn_waiting_cancel(gubun, rsvnIdx) {
		...
		if (confirm("해당 강연/행사/영화 예약을 정말 취소하시겠습니까?")) {
