...
<c:forEach items="${list}" var="resultVO" varStatus="status">
                <tr>
                  ...
                  <td class="state">
					<a href="<c:url value='./myCancelDetail?edcRsvnReqid=${resultVO.edcRsvnReqid}'/><c:out value="${commandMap.query}"/>" class="flag flag-green" style="margin-top:2px;margin-bottom:2px;">상세보기</a>
        ...
        <div class="paginate pc">
 				<tags:UserPaging pageInfo="${paginationInfo}" pageUrl="./myRefundList?pageIndex="/>
        </div>
