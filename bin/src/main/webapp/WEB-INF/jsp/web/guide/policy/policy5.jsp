...
<%@ include file="../../../include/top.jsp"%>
				<h4 class="tit2">제1조(개인정보 처리목적)</h4>
							...
							<p class="txt mb30">정보주체는 아래의 기관에 대해 개인정보 침해에 대한 피해구제, 상담 등을 문의하실 수 있습니다.<br> 아래의 기관은 노원수학문화관과는 별개의 기관으로서 노원수학문화관의 자체적인 개인정보 불만처리, 피해구제 결과에 만족하지 못하시거나 보다 자세한 도움이 필요하시면 문의하여 주시기 바랍니다.</p>
							<ul class="mb30">
								<li>
							...
							<p>이 개인정보처리방침은 2018. 1. 18.부터 적용됩니다.</p>
							<!-- //제 11조 -->
							<input type="hidden" id="dt" value="2018. 1. 18"/>