...
<%@ include file="../../../include/top.jsp"%>
					...
					<ol class="mb30">
						<li>
							...
							<ol>
								<li class="num_p">(1) 홈페이지 회원 가입 및 관리 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 만 14세 미만 아동의 개인정보 처리시 법정대리인의 동의여부 확인, 각종 고지·통지, 고충처리 등을 목적으로 개인정보를 처리합니다.</li>
					...
					<p class="txt mb55">노원수학문화관은 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보보호법」 제17조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</p>
					<!-- //제3조 -->
					<!-- 제4조 -->
					...
					<ol class="mb55">
						<li>
							<p>1. 정보주체(만14세 미만인 경우에는 법정대리인을 말함)는 노원수학문화관에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.</p>
						</li>
						<li>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>이름, 생년월일, E-mail, 주소, 전화번호</td>
										</tr>
										<tr>
											<td>4</td>
											<td>노원수학문화관 특별회원 명부</td>
											<td>이름, 생년월일, E-mail, 주소, 전화번호, 가족성명, 가족생년월일</td>
										</tr>
										<tr>
											<td>5</td>
					...
					<ol class="mb55">
						...
						<li>
							<p>2. 정보주체로부터 동의 받은 개인정보 보유기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보(또는 개인정보파일)을 별도의 데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.</p>
						</li>
						<li>
							...
							<ol>
								<li>
									...
									<ul class="dot_list">
										<li>노원수학문화관은 파기하여야 하는 개인정보(또는 개인정보파일)에 대해 개인정보 파기계획을 수립하여 파기합니다. 노원수학문화관은 파기 사유가 발생한 개인정보(또는 개인정보파일)을 선정하고, 노원수학문화관은 개인정보 보호책임자의 승인을 받아 개인정보(또는 개인정보파일)을 파기합니다.</li>
										<li class="dot">개인정보 파기 : 보유기간이 경과한 개인정보는 종료일로부터 지체 없이 파기합니다.</li>
										<li class="dot">개인정보파일 파기 : 개인정보파일의 처리목적 달성, 해당 서비스의 폐지, 사업의 종료 등 그 개인정보파일이 불필요하게 되었을 때에는 개인정보의 처리가 불필요한 것으로 인정되는 날로부터 지체 없이 그 개인정보파일을 파기합니다.</li>
									</ul>
								</li>
								<li>
					...
					<ol class="mb55">
						...
						<li>
							...
							<ul class="sub_p_list">
								<li class="sub_p">- 쿠키의 사용목적 : 노원수학문화관 홈페이지의 소셜 로그인 상태를 유지하기 위해 사용합니다.</li>
					...
					<ol class="mb55">
						<li>
							...
							<ul class="sub_p_list">
								<li class="sub_p">- 관람총괄과 이상명, 042-601-7905 <a href="mailto:smlee0988@korea.kr">smlee0988@korea.kr</a></li>
								<li class="sub_p">- 개인정보보호 담당자 : 경영기획과 장미경, 042-601-7867 <a href="mailto:wkdalrud@korea.kr">wkdalrud@korea.kr</a></li>
							</ul>
						</li>
						<li>
					...
					<ul class="mb55">
						...
						<li>
							...
							<ul class="dot_list2">
								<li>02-3480-3573(<a href="http://www.spo.go.kr" target="_blank">http://www.spo.go.kr</a>, <a href="mailto:cybercid@spo.go.kr" target="_blank">cybercid@spo.go.kr)</a></li>
							</ul>
						</li>
						<li>
							<p class="dot">경찰청 사이버안전국</p>
							<ul class="dot_list2">
								<li>182(<a href="http://cyberbureau.police.go.kr/index.do" target="_blank">http://cyberbureau.police.go.kr</a>)</li>
							</ul>
						</li>
					</ul>
					<!-- //제12조 -->
					...
					<ol class="mb55">
						<li><p>1. 이 개인정보 처리방침은 2018. 3. 15.부터 적용됩니다.</p></li>
						<li><p>2. 이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.</p></li>
					</ol>
					<!-- //제 13조 -->
					<input type="hidden" id="dt" value="2018. 3. 15"/>