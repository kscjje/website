...
<%@ include file="../../../include/top.jsp"%>
				<!-- 제1조 -->
										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													<td>온마음초청교육행사 대행</td>
													<td>㈜마이스피플</td>
													<td>2017. 3. 8.~12. 15.</td>
													<td>온마음 초청행사 운영</td>
												</tr>
												<tr>
													<td>8</td>
													<td>연구진흥과</td>
													<td>국제 노원수학문화관 심포지엄 학술대회</td>
													<td>(주)유니원커뮤니케이션즈</td>
													<td>2017. 6. 13.~12. 30.</td>
													<td>국제과학심포지언 행사 운영</td>
												</tr>
												<tr>
													<td>9</td>
													<td>연구진흥과</td>
													<td>노원수학문화관 전문인력양성사업	</td>
													<td>사단법인 한국노원수학문화관협회</td>
													<td>2017. 6. 8.~12. 30.</td>
													<td>전문인력양성 교육 운영</td>
												</tr>
												<tr>
													<td>10</td>
													<td>과학교육과</td>
													<td>여름방학 STEAM 과학캠프	</td>
													<td>㈜드림미즈</td>
													<td>2017. 7. 12 ~ 8. 31.</td>
													<td>캠프운영 및 수료증 발급</td>
												</tr>
											</tbody>
										</table>
							...
							<ul class="dot_list2 ty mb30">
								<li class="dot">개인정보보호 책임자: 관람총괄과 정원영 042-601-7760, nemo59@korea.kr</li>
							...
							<p>이 개인정보처리방침은 2017. 6. 27.부터 적용됩니다.</p>
							<!-- //제 11조 -->
							<input type="hidden" id="dt" value="2017. 6. 27 "/>