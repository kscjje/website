...
<%@ include file="../../../include/top.jsp"%>
	<!-- 제1조 -->
							...
							<ol class="mb55">
								...
								<li>
									<p>2. 제1항에 따른 권리 행사는 노원수학문화관에 대해 개인정보보호법 시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수 있으며, 노원수학문화관은 이에 대해 지체 없이 조치하겠습니다.</p>
								</li>
								<li>
									<p>3. 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 노원수학문화관은 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.</p>
								</li>
								<li>
									<p>4. 제1항에 따른 권리 행사는 정보주체의 법정대리인의 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보보호법 시행규칙 별지 제11호 서식에 따라 위임장을 제출하셔야 합니다.</p>
								</li>
								<li>
								...
								<li>
									<p>7. 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구, 처리정지의 요구시 열람 등 요구를 한 자가 본인이거나 정당한 대리인인지를 확인합니다.</p>
									<ul class="dot_list2">
										...
										<li>정보주체는 노원수학문화관의 열람청구 접수·처리부서(하단, 제9조 개인정보보호(분야별)책임자 및 담당자 연락처 참조) 이외에 행정자치부의 ‘개인정보보호 종합지원포털(<a href="http://www.privacy.go.kr" target="_blank">http://www.privacy.go.kr</a>)’을 통해 개인정보 열람청구를 하실 수 있습니다.</li>
									</ul>
								</li>
							</ol>
							<!-- //제5조 -->
							...
							<p>이 개인정보처리방침은 2018. 3. 14.부터 적용됩니다.</p>
							<!-- //제 11조 -->
							<input type="hidden" id="dt" value="2018. 3. 14"/>