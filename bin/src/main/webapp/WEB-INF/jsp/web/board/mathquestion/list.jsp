...
<%
 /**
  * @Class Name : mathquestion/list.jsp
  * @Description : 목록 JSP
...
<%@ include file="/WEB-INF/templates/web/base/subMenu.jsp"%>
			...
			<div class="sub_cont" id="container">
				<div class="inner">
					...
					<div class="polymath">
						<img src="/web/resources/site/images/polymath.png" alt="폴리매스" /> 와 함께 합니다
					</div>					
							...
							<tbody>
								...
								<c:if test="${paginationInfo.currentPageNo < 2 }">
									...
									<c:forEach items="${noticeList}" var="resultInfo" varStatus="status">
										<tr class="n_top">
											<td class="number">
												<img src="<%=strContext%>/images/sub/ico_notice.png" alt="중요공지아이콘">
											</td>
											<td class="title left">
												<c:choose>
