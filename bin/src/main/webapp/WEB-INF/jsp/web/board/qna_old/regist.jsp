				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td class="b">
								<label><input type="radio" class="radio" name="secretAt" value="Y" onclick="fnSecretAt(1);" checked="" /><em></em>&nbsp;<span>비공개</span></label>
								&nbsp;&nbsp;&nbsp;
								<label><input type="radio" class="radio" name="secretAt" value="N" onclick="fnSecretAt(2);" /><em></em>&nbsp;<span>공개</span></label>							
							</td>
						</tr>
						<tr>
