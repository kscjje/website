...
<div class="sub_cont" id="container">
	<div class="inner">
				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td class="b">
								<label><input type="radio" class="radio" name="secretAt" value="Y" onclick="fnSecretAt(1);" <c:if test="${articleVO.secretAt eq 'Y'}">checked=""</c:if> /><em></em>&nbsp;<span>비공개</span></label>
								&nbsp;&nbsp;&nbsp;
								<label><input type="radio" class="radio" name="secretAt" value="N" onclick="fnSecretAt(2);" <c:if test="${articleVO.secretAt eq 'N'}">checked=""</c:if> /><em></em>&nbsp;<span>공개</span></label>							
							</td>
						</tr>
						<tr>
		...
		<ul class="btn_area">
			...
			<li><a href="javascript:fn_egov_regist_article()" class="btn_ty_m_c1">저장</a></li>
		</ul>
