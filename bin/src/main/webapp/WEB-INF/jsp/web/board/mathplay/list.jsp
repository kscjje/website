...
<%@ include file="/WEB-INF/templates/web/base/subMenu.jsp"%>
			...
			<div class="sub_cont" id="container">
				<div class="inner">
					<h3 class="tit">
						<c:out value="${fn:replace(SELECTED_MENU_OBJ.menuNm , '[[[' , '')}" escapeXml="false" />
					</h3>
					<!-- 
					<div class="top_txt">
					...
					<div class="m_table">
						<table>
							<caption>${boardMasterVO.bbsNm} 목록 게시판 - 번호, 제목, 작성자, 등록일, 조회, 상태</caption>
							<thead>
								<tr>
								...
								<tr class="n_top">
									...
									<td class="title left">
										<a href="#">
											<i class="lock">
											<img src="<%=strContext%>/images/sub/ico_lock.png" alt="잠금아이콘" />
											</i>2021년 가을 사이언스 페스티벌 관련 질문입니다.</a> 
										<i><img src="<%=strContext%>/images/sub/ico_file.png" alt="첨부파일아이콘" /></i>
									</td>
									<td class="writer">김길동</td>
									<td class="date">2021.07.20</td>
									<td class="date">56</td>
									<td class="state"><span class="st s1">대기</span></td>
								</tr>
								-->
