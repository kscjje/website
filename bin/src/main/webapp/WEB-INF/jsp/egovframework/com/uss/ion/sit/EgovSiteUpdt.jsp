<%
 /**
  * @Class Name : EgovSiteUpdt.jsp
  * @Description : EgovSiteUpdt 화면
...
function fn_egov_inqire_list() {
	siteVO.action = "<c:url value='/uss/ion/sit/selectSiteList.do'/>";
	siteVO.submit();	
}
</script>
</head>
...
<!-- 상단타이틀 -->
<form:form commandName="siteVO" action="${pageContext.request.contextPath}/uss/ion/sit/updateSite.do" method="post" onSubmit="fn_egov_updt_site(document.forms[0]); return false;">  
<div class="wTableFrm">
