...
<script language="javascript">
	...
	function init() {
		...
		var confmKey = "devU01TX0FVVEgyMDIwMDgxMzE0MzEzNDExMDA2MDQ=";//승인키
		...
		if (inputYn != "Y") {
			...
			document.form.returnUrl.value  = location.protocol + "//" + location.hostname + ":" + location.port + "/intrfc/adres/resultAdresToPage";
