package com.hisco.intrfc.coupon.mapper;
...
public interface CouponMapper {
     ...
     * @throws Exception
     */
    public List<?> selectCouponNumber(Map<String, Object> paramMap);
     ...
     * @throws Exception
     */
    public List<?> selectCouponExecuteList(Map<String, Object> paramMap);
    ...
    // List<CouponQstVO> qstList = (List<CouponQstVO>) commonDAO.queryForList("CouponDAO.selectCouponQstList", mstVO);
    //
    // for (CouponQstVO couponQstVO : qstList) {
    // List<CouponQstItemVO> itemList = (List<CouponQstItemVO>) commonDAO.queryForList("CouponDAO.selectQstItemList",
    // mstVO);
