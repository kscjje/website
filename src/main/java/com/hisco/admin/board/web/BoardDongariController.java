...
public class BoardDongariController {
     ...
     * @throws Exception
     */
    @PageActionInfo(title = "학습동아리 등록", action = "C")
    ...
    public String articleSave(@PathVariable String type, final MultipartHttpServletRequest multiRequest,
        ...
        if (articleVO.getNttId() > 0) {
            ...
            // step1 DB에서 해당 학습동아리의 uniqId 조회
        ...
        // status.setComplete();
        HttpUtility.sendRedirect(multiRequest, response, "처리되었습니다.", Config.ADMIN_ROOT + "/dongari/" + type + "/list" + commandMap.getString("searchQuery"));
