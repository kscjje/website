...
/**
 * @Class Name : EvtEdcrsvnMstVO.java
...
public class EvtEdcrsvnMstVO implements Serializable {
    ...
    private EvtEdcrsvnTimeVO timeVO;// 시간정보
    private List<EvtEdcItemAmountVO> chargeList;// 요금정보
    private List<EvtEdcRsvnItemVO> itemList;// 예약상세내역
    ...
    private String useinforYn;

    public String getUseinforYn() {
        return useinforYn;
    }

    public void setUseinforYn(String useinforYn) {
        this.useinforYn = useinforYn;
    }
    ...
    public EvtEdcrsvnTimeVO getTimeVO() {
        return timeVO;
    }

    public void setTimeVO(EvtEdcrsvnTimeVO timeVO) {
        this.timeVO = timeVO;
    }

    public List<EvtEdcItemAmountVO> getChargeList() {
        return chargeList;
    }

    public void setChargeList(List<EvtEdcItemAmountVO> chargeList) {
        this.chargeList = chargeList;
    }

    public List<EvtEdcRsvnItemVO> getItemList() {
        return itemList;
    }

    public void setItemList(List<EvtEdcRsvnItemVO> itemList) {
