...
// import com.knsoft.extend.AbstractController;
// import com.knsoft.kntool.KntoolInfo;
...
public class RequestUtil extends HashMap<String, Object> {
    ...
    public boolean isSetupUrl() {
         ...
         * path = getPath();
         * return path.replaceAll(SLASH, "").indexOf(KntoolInfo.SETUP_ROOT) == 0;
         */

        log.debug("call RequestUtil :: isSetupUrl()");
    ...
    public boolean isAdminUrl() {
         ...
         * if (StringUtil.IsEmpty(path))
         * path = getPath();
         * return path.replaceAll(SLASH, "").indexOf(KntoolInfo.ADMIN_ROOT) == 0;
         */

        log.debug("call RequestUtil :: isAdminUrl()");
    ...
    public String getViewType() {
        ...
        log.debug("call RequestUtil :: getViewType()");
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T KntoolModuleConfigInfo() {
