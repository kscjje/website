...
class OracleRdbmsSpecifics extends RdbmsSpecifics {
    ...
    String formatParameterObject(Object object) {
        if (object instanceof Timestamp) {
            return "to_timestamp('" + new SimpleDateFormat("MM/dd/yyyy HH:mm:ss.SSS", Locale.KOREA).format(object) + "', 'mm/dd/yyyy hh24:mi:ss.ff3')";
        } else if (object instanceof Date) {
            return "to_date('" + new SimpleDateFormat("MM/dd/yyyy HH:mm:ss", Locale.KOREA).format(object) + "', 'mm/dd/yyyy hh24:mi:ss')";
        } else {
