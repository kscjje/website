...
public class PostLogProfilerProcessor {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length < 1) {
            // log.debug("usage: java PostLogProfilerProcessor <log-file>");
            System.exit(1);
        }
     ...
     * @param out
     *            PrintStream to write profiling report to.
     * @throws Exception
    ...
    private class ProfiledSql implements Comparable {
         ...
         * 
         * @param o
         *            ProfiledSql Object to compare to this ProfiledSql. Must not be null.
         */
