...
public class DefaultResultSetCollector implements ResultSetCollector {
    ...
    private static final List<String> GETTERS = Arrays.asList(new String[] { "getString", "getLong", "getInt", "getDate", "getTimestamp", "getTime", "getBigDecimal", "getFloat", "getDouble", "getByte", "getShort", "getObject", "getBoolean", });
     ...
     * java.lang.Object)
     */
    public boolean methodReturned(ResultSetSpy resultSetSpy, String methodCall, Object returnValue, Object targetObject,
            Object... methodParams) {
