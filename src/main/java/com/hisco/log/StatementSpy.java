...
public class StatementSpy implements Statement, Spy {
     ...
     * @param realStatement
     *            real underlying Statement that this StatementSpy wraps.
     */
     ...
     *            the SQL being run
     * @param methodCall
     *            the name of the method that was running the SQL
     */
    protected void reportStatementSql(String sql, String methodCall) {
        ...
        _reportSql((DriverSpy.statementUsageWarn ? SQL_WARNING : "") + sql, methodCall);
    }
    ...
    protected void reportStatementSqlTiming(long execTime, String sql, String methodCall) {
        // redirect to one more method call ONLY so that stack trace search is consistent
        // with the reportReturn calls
        _reportSqlTiming(execTime, (DriverSpy.statementUsageWarn ? SQL_WARNING : "") + sql, methodCall);
    }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return (T) reportReturn(methodCall, (iface != null && (iface == Connection.class || iface == Spy.class))
                    ? (T) this : realStatement.unwrap(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public void closeOnCompletion() throws SQLException {
        ...
        // log.debug("call StatementSpy closeOnCompletion()");
    }

    @Override
    public boolean isCloseOnCompletion() throws SQLException {
        // TODO Auto-generated method stub
        // log.debug("call StatementSpy isCloseOnCompletion()");
        return false;
    }
