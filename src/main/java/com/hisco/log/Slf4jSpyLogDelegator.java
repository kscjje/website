...
public class Slf4jSpyLogDelegator implements SpyLogDelegator {
    ...
    public boolean isJdbcLoggingEnabled() {
        return jdbcLogger.isErrorEnabled() || resultSetLogger.isErrorEnabled() || sqlOnlyLogger.isErrorEnabled() || sqlTimingLogger.isErrorEnabled() || connectionLogger.isErrorEnabled() || resultSetTableLogger.isErrorEnabled();
    }
     ...
     *
     * @param spy
     *            the Spy wrapping the class that called the method that
     *            returned.
     * @param methodCall
     *            a description of the name and call parameters of the
     *            method that returned.
     * @param returnMsg
     *            return value converted to a String for integral types, or
    ...
    public void methodReturned(Spy spy, String methodCall, Object returnMsg, Object object, Object... methodParams) {
        String classType = spy.getClassType();
        Logger logger = ResultSetSpy.CLASS_TYPE.equals(classType) ? resultSetLogger : jdbcLogger;
    ...
    private boolean shouldSqlBeLogged(String sql) {
        ...
        return (DriverSpy.dumpSqlSelect && "select".equals(mysql)) || (DriverSpy.dumpSqlInsert && "insert".equals(mysql)) || (DriverSpy.dumpSqlUpdate && "update".equals(mysql)) || (DriverSpy.dumpSqlDelete && "delete".equals(mysql)) || (DriverSpy.dumpSqlCreate && "create".equals(mysql));
    }
