...
public class SpyLogFactory {
    ...
    /**
     * Get the default SpyLogDelegator for logging to the log.
     *
     * @return the default SpyLogDelegator for logging to the log.
     */
     ...
     * 
     * @param logDelegator
     *            the log delegator responsible for actually logging
     *            JDBC events.
     */
