...
public class CallableStatementSpy extends PreparedStatementSpy implements CallableStatement {
     ...
     *
     * @param sql
     *            The SQL used for this CallableStatement
     * @param connectionSpy
     *            The ConnectionSpy which produced this CallableStatementSpy
     * @param realCallableStatement
     *            The real CallableStatement that is being spied upon
     */
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return (T) reportReturn(methodCall, (iface != null && (iface == CallableStatement.class || iface == PreparedStatement.class || iface == Statement.class || iface == Spy.class))
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        try {
            ...
            return reportReturn(methodCall, (iface != null && (iface == CallableStatement.class || iface == PreparedStatement.class || iface == Statement.class || iface == Spy.class)) || realCallableStatement.isWrapperFor(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public <T> T getObject(int parameterIndex, Class<T> type) throws SQLException {
        ...
        // log.debug("call CallableStatementSpy getObject(int)");
        return null;
    }
    ...
    public <T> T getObject(String parameterName, Class<T> type) throws SQLException {
        // TODO Auto-generated method stub
        // log.debug("call CallableStatementSpy getObject(String)");
        return null;
    }
