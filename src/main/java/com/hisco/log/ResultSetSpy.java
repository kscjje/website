...
public class ResultSetSpy implements ResultSet, Spy {
     ...
     *
     * @param methodCall
     *            description of method call and arguments passed to it that generated the exception.
     * @param exception
     ...
     * @param msg
     *            description of what the return value that was returned. may be an empty String for void return types.
     */
     ...
     * @param realResultSet
     *            real underlying ResultSet that is being wrapped.
     */
    ...
    public Object getObject(int columnIndex) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, realResultSet.getObject(columnIndex), new Object[] { columnIndex });
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Object getObject(String columnName) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, realResultSet.getObject(columnName), new Object[] { columnName });
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public Object getObject(String colName, Map map) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, realResultSet.getObject(colName, map), new Object[] { colName, map });
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public boolean next() throws SQLException {
        ...
        try {
            if (resultSetCollector != null) {
                // Give the result set collector a chance to fill in unread values from the result set row if that
    ...
    public Object getObject(int columnIndex, Map<String, Class<?>> map) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, realResultSet.getObject(columnIndex, map), new Object[] { columnIndex, map });
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return (T) reportReturn(methodCall, (iface != null && (iface == ResultSet.class || iface == Spy.class))
                    ? (T) this : realResultSet.unwrap(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        try {
            return reportReturn(methodCall, (iface != null && (iface == ResultSet.class || iface == Spy.class)) || realResultSet.isWrapperFor(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
        ...
        // log.debug("call ResultSetSpy closeOnCompletion()");
        return null;
    }
