...
public class PreparedStatementSpy extends StatementSpy implements PreparedStatement {
     ...
     *
     * @param i
     *            index of argument being set.
     * @param typeHelper
     *            optional additional info about the type that is being set in the arg
     * @param arg
     *            argument being bound.
     */
     ...
     *
     * @param sql
     *            SQL for the prepared statement that is being spied upon.
     * @param connectionSpy
     *            ConnectionSpy that was called to produce this PreparedStatement.
     * @param realPreparedStatement
     *            The actual PreparedStatement that is being spied upon.
     */
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        ...
        try {
            ...
            return (T) reportReturn(methodCall, (iface != null && (iface == PreparedStatement.class || iface == Statement.class || iface == Spy.class))
                    ? (T) this : realPreparedStatement.unwrap(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
    ...
    public boolean isWrapperFor(Class<?> iface) throws SQLException {
        ...
        try {
            ...
            return reportReturn(methodCall, (iface != null && (iface == PreparedStatement.class || iface == Statement.class || iface == Spy.class)) || realPreparedStatement.isWrapperFor(iface));
        } catch (SQLException s) {
            reportException(methodCall, s);
            throw s;
        }
