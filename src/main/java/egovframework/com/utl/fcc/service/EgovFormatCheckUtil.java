...
public class EgovFormatCheckUtil {
    ...
    /**
     * <pxxx - xxx- xxxx 형식의 전화번호 앞, 중간, 뒤 문자열 3개 입력 받아 유요한 전화번호형식인지 검사.
     * </p>
     * 
     * @param 전화번호
     *            문자열( 3개 )
    ...
    public static boolean checkFormatTell(String tell1, String tell2, String tell3) {
        ...
        String[] check = { "02", "031", "032", "033", "041", "042", "043", "051", "052", "053", "054", "055", "061", "062", "063", "070", "080", "0505" }; // 존재하는
                                                                                                                                                           // 국번
                                                                                                                                                           // 데이터
        ...
        if (tell1.equals("02")) {
            if (tell2.length() != 3 && tell2.length() != 4)
                return false;
            if (tell3.length() != 4)
