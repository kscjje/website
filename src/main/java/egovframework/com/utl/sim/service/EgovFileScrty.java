...
public class EgovFileScrty {
     ...
     * log.debug(password + " => " + first + " : " + checkPassword(password, first, salt.getBytes()));
     * log.debug(password + " => " + second + " : " + checkPassword(password, second, salt.getBytes()));
     * } catch (Exception ex) {
     * ex.printStackTrace();
     * }
     * }
