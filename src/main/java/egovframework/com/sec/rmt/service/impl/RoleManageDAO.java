...
public class RoleManageDAO extends EgovComAbstractDAO {
    ...
    public RoleManage selectRole(RoleManage roleManage) throws Exception {
        return (RoleManage) selectOne("roleManageDAO.selectRole", roleManage);
    }
     ...
     * @exception Exception
     */
    public void deleteRoleRelate(RoleManage roleManage) throws Exception {
        delete("roleManageDAO.deleteRoleRelate", roleManage);
    }
