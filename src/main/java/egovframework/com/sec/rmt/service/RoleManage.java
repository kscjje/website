...
public class RoleManage extends ComDefaultVO {
    ...
    /**
     * roleCodeCheck attribute 를 리턴한다.
     * 
     * @return String
     */
    public String[] getRoleCodeCheck() {
        return roleCodeCheck;
    }

    /**
     * roleCodeCheck attribute 값을 설정한다.
     * 
     * @param authorCode
     *            String
     */
    public void setRoleCodeCheck(String[] roleCodeCheck) {
        this.roleCodeCheck = roleCodeCheck;
    }
