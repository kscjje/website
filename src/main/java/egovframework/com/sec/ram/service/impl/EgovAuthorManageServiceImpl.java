...
public class EgovAuthorManageServiceImpl extends EgovAbstractServiceImpl implements EgovAuthorManageService {
     ...
     * @exception Exception
     */
    public int selectAuthorCodeCheck(AuthorManage authorManage) throws Exception {
        return authorManageDAO.selectAuthorCodeCheck(authorManage);
    }
    ...
    public void insertAuthor(AuthorManage authorManage) throws Exception {
        ...
        int cnt = authorManageDAO.selectAuthorRoleCount(authorManage);
        authorManageDAO.insertAuthor(authorManage);

        // 권한 상속 부분도 insert
        if (cnt < 1) {
            authorManageDAO.insertAuthorRole(authorManage);
        }
    }
    ...
    public void deleteAuthor(AuthorManage authorManage) throws Exception {
        ...
        vo.setAuthorCode(authorManage.getAuthorCode());
        menuCreateManageDAO.deleteMenuCreat(vo);

        authorManageDAO.deleteAuthorRole(authorManage);
     ...
     * @exception Exception
     */
    public int selectAuthorRoleCount(AuthorManageVO authorManageVO) throws Exception {
        return authorManageDAO.selectAuthorRoleCount(authorManageVO);
    }
     ...
     * @exception Exception
     */
    public void insertAuthorRole(AuthorManageVO authorManage) throws Exception {
        authorManageDAO.insertAuthorRole(authorManage);
    }
}
