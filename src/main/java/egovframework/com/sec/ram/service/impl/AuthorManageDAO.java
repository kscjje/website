...
public class AuthorManageDAO extends EgovComAbstractDAO {
     ...
     * @exception Exception
     */
    public int selectAuthorRoleCount(AuthorManage authorManageVO) throws Exception {
        return (Integer) selectOne("authorManageDAO.selectAuthorRoleCount", authorManageVO);
    }
     ...
     * @exception Exception
     */
    public int selectAuthorCodeCheck(AuthorManage authorManageVO) throws Exception {
        return (Integer) selectOne("authorManageDAO.selectAuthorCodeCheck", authorManageVO);
    }
     ...
     * @exception Exception
     */
    public void insertAuthorRole(AuthorManage authorManageVO) throws Exception {
        insert("authorManageDAO.insertAuthorRole", authorManageVO);
    }
     ...
     * @exception Exception
     */
    public void deleteAuthorRole(AuthorManage authorManageVO) throws Exception {
        delete("authorManageDAO.deleteAuthorRole", authorManageVO);
    }
}
