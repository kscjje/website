...
public class AuthorRoleManageDAO extends EgovComAbstractDAO {
    ...
    /**
     * 권한 롤 관계정보를 권한코드로 조회하여 데이터베이스에서 삭제
     * 
     * @param authorRoleManage
     *            AuthorRoleManage
     * @exception Exception
     */
    public void deleteAuthorRoleByAuthorCode(AuthorRoleManage authorRoleManage) throws Exception {
        delete("authorRoleManageDAO.deleteAuthorRoleByAuthorCode", authorRoleManage);
    }
    ...
    /**
     * 수정된 권한 롤 의 메뉴정보를 초기화
     * 
     * @param authorRoleManage
     *            AuthorRoleManage
     * @exception Exception
     */
    public void updateAuthorRoleMenuNull(AuthorRoleManage authorRoleManage) throws Exception {
        // 초기화
        update("authorRoleManageDAO.updateAuthorRoleMenuNull", authorRoleManage);

    }

    /**
     * 수정된 권한 롤 의 메뉴정보를 데이터베이스에 반영
     * 
     * @param authorRoleManage
     *            AuthorRoleManage
     * @exception Exception
     */
    public void updateAuthorRoleMenu(AuthorRoleManage authorRoleManage) throws Exception {
        // 업데이트
        update("authorRoleManageDAO.updateAuthorRoleMenu", authorRoleManage);
    }
