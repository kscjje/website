...
public class AuthorRoleManage extends ComDefaultVO {
    ...
    /**
     * roleMenuNo attribute 를 리턴한다.
     * 
     * @return String
     */
    public long getRoleMenuNo() {
        return roleMenuNo;
    }

    /**
     * roleMenuNo attribute 값을 설정한다.
     * 
     * @param roleMenuNo
     *            String
     */
    public void setRoleMenuNo(long roleMenuNo) {
        this.roleMenuNo = roleMenuNo;
    }

    /**
     * authorCodeList attribute 를 리턴한다.
     * 
     * @return String
     */
    ...
    /**
     * authorCodeList attribute 값을 설정한다.
     * 
