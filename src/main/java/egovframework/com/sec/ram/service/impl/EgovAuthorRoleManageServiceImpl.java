...
public class EgovAuthorRoleManageServiceImpl extends EgovAbstractServiceImpl implements EgovAuthorRoleManageService {
    ...
    public void deleteAuthorRoleByAuthorCode(AuthorRoleManage authorRoleManage) throws Exception {
        authorRoleManageDAO.deleteAuthorRoleByAuthorCode(authorRoleManage);
    }
    ...
    public void updateAuthorRoleMenu(AuthorRoleManage authorRoleManage) throws Exception {
        ...
        authorRoleManageDAO.updateAuthorRoleMenuNull(authorRoleManage);

        if (authorRoleManage.getAuthorCodeList() != null && authorRoleManage.getAuthorCodeList().length > 0)
            authorRoleManageDAO.updateAuthorRoleMenu(authorRoleManage);
    }
}