...
public class BbsStatsDAO extends EgovComAbstractDAO {
    ...
    public void summaryBbsStats() throws Exception {
        ...
        sumVO.setDetailStatsKind("B001");
        parVO.setStatsKind("COM101");
        parVO.setDetailStatsKind("B001");
        // 1-0. 집계 여부 조회
        ...
        sumVO = new StatsVO();
        sumVO.setStatsKind("COM101");
        sumVO.setDetailStatsKind("B002");
        parVO.setStatsKind("COM101");
        parVO.setDetailStatsKind("B002");
        // 2-0. 집계 여부 조회
        resultVO = (StatsVO) selectOne("BbsStatsDAO.selectBbsSummary", parVO);
        if (resultVO == null || resultVO.getStatsKind() == null || "".equals(resultVO.getStatsKind())) {
            // 2-1. 생성글수
        ...
        sumVO = new StatsVO();
        sumVO.setStatsKind("COM101");
        sumVO.setDetailStatsKind("B003");
        parVO.setStatsKind("COM101");
        parVO.setDetailStatsKind("B003");
        // 3-0. 집계 여부 조회
        resultVO = (StatsVO) selectOne("BbsStatsDAO.selectBbsSummary", parVO);
        if (resultVO == null || resultVO.getStatsKind() == null || "".equals(resultVO.getStatsKind())) {
            // 3-1. 생성글수
        ...
        for (TemplateInfVO templateVO : resultWhiteList) {

            sumVO = new StatsVO();
            sumVO.setStatsKind("COM005");
            sumVO.setDetailStatsKind(templateVO.getTmplatId());
            parVO.setStatsKind("COM005");
            parVO.setDetailStatsKind(templateVO.getTmplatId());
        ...
        sumVO = new StatsVO();
        sumVO.setStatsKind("COM005");
        sumVO.setDetailStatsKind("T002");
        parVO.setStatsKind("COM005");
        parVO.setDetailStatsKind("T002");
        // 2-0. 집계 여부 조회
        resultVO = (StatsVO) selectOne("BbsStatsDAO.selectBbsSummary", parVO);
        if (resultVO == null || resultVO.getStatsKind() == null || "".equals(resultVO.getStatsKind())) {
            // 2-1. 생성글수
        ...
        sumVO = new StatsVO();
        sumVO.setStatsKind("COM005");
        sumVO.setDetailStatsKind("T003");
        parVO.setStatsKind("COM005");
        parVO.setDetailStatsKind("T003");
        // 3-0. 집계 여부 조회
        resultVO = (StatsVO) selectOne("BbsStatsDAO.selectBbsSummary", parVO);
        if (resultVO == null || resultVO.getStatsKind() == null || "".equals(resultVO.getStatsKind())) {
            // 3-1. 생성글수
