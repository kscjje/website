...
public class EgovBannerServiceImpl extends EgovAbstractServiceImpl implements EgovBannerService {
    ...
    public void updateBanner(Banner banner) throws Exception {
        if (banner.isAtchFile()) {
            bannerDAO.deleteBannerFile(banner);
        }
    ...
    public void deleteBannerFile(Banner banner) throws Exception {
        ...
        File file = new File(FileMngUtil.GetRealUploadPath() + fileVO.getFilePath(), fileVO.getFileName());
     ...
     * @return BannerVO - 배너 VO
     */
    public List<BannerVO> selectBannerListCurrent(BannerVO bannerVO) throws Exception {
        return bannerDAO.selectBannerListCurrent(bannerVO);
    }
