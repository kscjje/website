...
public class PopupManageDAO extends EgovComAbstractDAO {
    ...
    /**
     * 기 등록된 팝업창정보 정렬 팝업만 수정
     * 
     * @param updateStatPopup
     *            - 팝업창 model
     * @return boolean - 반영성공 여부
     * @param popupManage
     */
    public void updateStatPopup(PopupManageVO popupManageVO) throws Exception {
        update("PopupManage.updateStatPopupManage", popupManageVO);
    }
    ...
    /**
     * 기 등록된 팝업정보의 이미지파일을 삭제하기 위해 파일정보를 조회한다.
     * 
     * @param popupManageVO
     *            - 팝업창 model
     * @return FileVO - 파일 VO
     */
    public FileVO selectFile(PopupManageVO popupManageVO) throws Exception {
        return (FileVO) selectOne("PopupManage.selectFile", popupManageVO);
    }
