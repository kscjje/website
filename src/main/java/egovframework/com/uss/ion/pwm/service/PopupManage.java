...
public class PopupManage extends ComDefaultVO implements Serializable {
    ...
    private String popupLocationcd;
     ...
     */
    public void setLastUpdusrPnttm(Date lastUpdtPnttm) {
     ...
     * ntceBgndeYMD 리턴
     *
     * @return the ntceBgndeYMD
     */
    public String getNtceBgndeYMD() {
        return ntceBgndeYMD;
    }
     ...
     *            to set
     */
    public void setNtceBgndeYMD(String ntceBgndeYMD) {
        this.ntceBgndeYMD = ntceBgndeYMD;
    }

    /**
     * ntceEnddeYMD 리턴
     *
     * @return the ntceEnddeYMD
     */
    public String getNtceEnddeYMD() {
        return ntceEnddeYMD;
    }
     ...
     *            to set
     */
    public void setNtceEnddeYMD(String ntceEnddeYMD) {
        this.ntceEnddeYMD = ntceEnddeYMD;
    }
    ...
    public String getPopupLocationcd() {
        return popupLocationcd;
    }

    public void setPopupLocationcd(String popupLocationcd) {
        this.popupLocationcd = popupLocationcd;
    }
