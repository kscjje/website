 ...
 *   2020.07.16  진수진    메뉴별 등록/수정/삭제 권한 추가
 *      </pre>
 */
...
public class MenuCreateManageDAO extends EgovComAbstractDAO {
     ...
     * @exception Exception
     */
    public void deleteMenuRole(MenuCreatVO vo) {
        delete("menuManageDAO.deleteMenuCreat_Role", vo);
    }
     ...
     * @exception Exception
     */
    public void insertMenuRole(MenuCreatVO vo) {
        update("menuManageDAO.insertMenuCreat_Role", vo);
    }
     ...
     * @exception Exception
     */
    public void updateMenuCreatIns(MenuCreatVO vo) {
        update("menuManageDAO.updateMenuCreat_Ins", vo);
    }
     ...
     * @exception Exception
     */
    public void updateMenuCreatUpd(MenuCreatVO vo) {
        update("menuManageDAO.updateMenuCreat_Upd", vo);
    }
     ...
     * @exception Exception
     */
    public void updateMenuCreatDel(MenuCreatVO vo) {
        update("menuManageDAO.updateMenuCreat_Del", vo);
    }
     ...
     * @exception Exception
     */
    public int selectMenuAllCnt(MenuCreatVO vo) {
        return (Integer) selectOne("menuManageDAO.selectMenuCreatCnt_All", vo);
    }
