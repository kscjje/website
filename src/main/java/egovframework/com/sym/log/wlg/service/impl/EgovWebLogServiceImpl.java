...
import egovframework.com.sym.log.wlg.service.ErrorWebLog;
...
public class EgovWebLogServiceImpl extends EgovAbstractServiceImpl implements EgovWebLogService {
    ...
    public void logInsertWebLog(WebLog webLog) throws Exception {
        ...
        // log.debug("call EgovWebLogServiceImpl = logInsertWebLog");
    ...
    public Map<String, Object> selectWebLogInf(WebLog webLog) throws Exception {
        List<?> result = webLogDAO.selectWebLogInf(webLog);
        int cnt = webLogDAO.selectWebLogInfCnt(webLog);
     ...
     */
    @Override
    public void errorInsertWebLog(ErrorWebLog errorWebLog) throws Exception {
        webLogDAO.errorInsertWebLog(errorWebLog);
    }
}
