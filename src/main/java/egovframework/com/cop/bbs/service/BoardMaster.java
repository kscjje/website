...
public class BoardMaster extends ComDefaultVO implements Serializable {
    ...
    /** 첨부가능파일확장자 */
    private String atchPosblFileExt = "";
    ...
    public String getAtchPosblFileExt() {
        return atchPosblFileExt;
    }

    public void setAtchPosblFileExt(String atchPosblFileExt) {
        this.atchPosblFileExt = atchPosblFileExt;
    }
    ...
    public String getUrlLnikyn() {
        return urlLnikyn;
    }

    public void setUrlLnikyn(String urlLnikyn) {
        this.urlLnikyn = urlLnikyn;
    }
