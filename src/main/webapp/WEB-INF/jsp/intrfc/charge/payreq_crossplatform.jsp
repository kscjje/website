...
<!-- 
 	파일명 : payreq_crossplatform.jsp
 	내  용 : toss payments 결제 요청
-->

<%

	//System.out.println("call payreq_crossplatform");
    ...
    /* ※ 중요
 	 ...
 	 */
 	//String configPath = "C:/hisco/egovWorkspace/SCR-WEB/src/main/webapp/WEB-INF/lgdacom";  //토스페이먼츠에서 제공한 환경파일("/conf/lgdacom.conf,/conf/mall.conf") 위치 지정.
 	//String configPath = "C:/hisco/egovWorkspace/SCR-WEB/src/main/webapp/lgdacom";
 	//String configPath = "C:/hisco/egovWorkspace/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SCR-WEB/WEB-INF/lgdacom";
 	
 	String strConfigPath = EgovProperties.getProperty("tosspayments.conf.path");
 	String strReturnUrlDomain = EgovProperties.getProperty("tosspayments.returnurl.domain");

 	//System.out.println("-----S");
 	//System.out.println("toss payments conf path     : " + strConfigPath);
 	//System.out.println("toss payments returnurl domain : " + strReturnUrlDomain);
     ...
     */
    //String LGD_RETURNURL		= "https://상점URL/returnurl.jsp";
    
    //String LGD_RETURNURL		= "http://localhost:8081/intrfc/charge/return/returnCallNsmUrl";
    //String LGD_RETURNURL		= "/intrfc/charge/returnCallNsmUrl";
    
    String strCsrf = request.getParameter("_csrf");
    
    //System.out.println("strCsrf = " + strCsrf);
    
    //String LGD_RETURNURL		= strReturnUrlDomain + "intrfc/charge/return/returnCallNsmUrl";
   	//String LGD_RETURNURL		= strReturnUrlDomain + "intrfc/charge/remoteCallNsmUrl";
   	//String LGD_RETURNURL		= strReturnUrlDomain + "intrfc/charge/remoteCallNsmUrl?_csrf=" + strCsrf;
   	String LGD_RETURNURL		= strReturnUrlDomain + "intrfc/charge/return/reCallNsmUrl?_csrf=" + strCsrf;
     ...
     */
     ...
     try {
    	 ...
    	 xpay = new XPayClient();
    	 xpay.Init(strConfigPath, CST_PLATFORM);
    	 ...
    	 //System.out.println("LGD_AMOUNT    = " + LGD_AMOUNT);
    	 //System.out.println("LGD_TIMESTAMP = " + LGD_TIMESTAMP);
    	 //System.out.println("LGD_HASHDATA  = " + LGD_HASHDATA);
    	 
     } catch(Exception e) {
    	 
		e.printStackTrace();
    	//System.out.println("토스페이먼츠 제공 API를 사용할 수 없습니다. 환경파일 설정을 확인해 주시기 바랍니다. ");
...
function payment_return() {
	...
	if (fDoc.document.getElementById('LGD_RESPCODE').value == "0000") {
		...
		document.getElementById("LGD_PAYINFO").method = "post";
		//document.getElementById("LGD_PAYINFO").action = "/intrfc/charge/return/resNsmPay";
		//document.getElementById("LGD_PAYINFO").action = "/intrfc/charge/payresNsmPay?_csrf=";
		document.getElementById("LGD_PAYINFO").action = "/intrfc/charge/payresNsmPay";
		...
		document.write(varReturnCd);
		document.write("<br/><br/>");
		document.write(varReturnMsg);
		
		fn_ajaxIfOnly("/intrfc/charge/pgOrdMstFinalSave", {COMCD : "<%= strCOMCD %>", LGD_OID : "<%= LGD_OID %>", OID_STAT : "3001", REQUEST_RESULT : varReturnMsg},  fn_callBack);
...
<!-- <form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="/intrfc/charge/return/resNsmPay" accept-charset="euc-kr"> -->
<form method="post" name="LGD_PAYINFO" id="LGD_PAYINFO" action="/intrfc/charge/payresNsmPay" accept-charset="euc-kr">
	...
	<table>
	    ...
	    <tr>
	        <td colspan="2">
			<input type="button" value="인증요청" onclick="fn_launchCrossPlatform();"/>
	        </td>
	    </tr>
	</table>
