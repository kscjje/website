...
<body>
	<section class="status_ui" style="text-align:center;">
		<div class="wrapper">
			<div class="st_head">
				<h1 class="logo"><img src="<%=strContext%>/stat/images/logo.png" alt="노원수학문화관로고"></h1>
				<span class="title">유료 관람 매표현황</span>
				<span class="m_date"></span>
				<span class="s_date"></span>&nbsp;<input type="image" id="dateToday" src="<%=strContext%>/images/main/calendar00.png">

				<!--
				<div class="tel">

					<i><img src="<%=strContext%>/stat/images/ico_tel.png" alt="전화아이콘"></i> <span>노원수학문화관 매표소 042-601-7732</span>
			...
			<div class="st_list">
				<div class="st">
					<div class="table t1_2 mb30" id="PART_0011">
