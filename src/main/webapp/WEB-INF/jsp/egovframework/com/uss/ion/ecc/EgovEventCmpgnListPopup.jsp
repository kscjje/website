...
<div class="popup">
		...
		<ul>
			<li>
				<select name="searchCondition" title="<spring:message code="title.searchCondition" /> <spring:message code="input.cSelect" />">
					<option value="0"  <c:if test="${searchVO.searchCondition == '0'}">selected="selected"</c:if> ><spring:message code="comUssIonEcc.eventCmpgnVO.eventCn" /></option><!-- 강연/행사/영화 내용 -->
	...
	<tr>
		...
		<th><spring:message code="comUssIonEcc.eventCmpgnVO.eventTyCode" /></th><!-- 강연/행사/영화 유형 -->
		<th class="board_th_link"><spring:message code="comUssIonEcc.eventCmpgnVO.eventCn" /></th><!-- 강연/행사/영화 내용 -->
		<th><spring:message code="comUssIonEcc.eventCmpgnVO.eventSvcBeginDe" /></th><!-- 강연/행사/영화 시작일 -->
		<th><spring:message code="comUssIonEcc.eventCmpgnVO.eventSvcEndDe" /></th><!-- 강연/행사/영화 종료일 -->
