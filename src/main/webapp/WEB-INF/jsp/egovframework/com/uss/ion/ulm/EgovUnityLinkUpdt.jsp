...
<form:form commandName="unityLink" name="unityLink" action="${pageContext.request.contextPath}/uss/ion/ulm/updtUnityLink.do" method="post" enctype="multipart/form-data" >
