<%
	/**
	 * @Class Name : EgovTnextrlHrUpdt.jsp
	 * @Description : EgovTnextrlHrUpdt 화면
...
<!-- 상단타이틀 -->
<form:form commandName="tnextrlHrVO" action="${pageContext.request.contextPath}/uss/ion/ecc/updateTnextrlHr.do" method="post" onSubmit="fn_egov_updt_hr(document.forms[0]); return false;" >
	<div class="wTableFrm">
	...
	<span class="btn_s"><a href="<c:url value='/uss/ion/ecc/selectTnextrlHrList.do' />"  title="<spring:message code="button.list" /> <spring:message code="input.button" />"><spring:message code="button.list" /></a></span></div>
