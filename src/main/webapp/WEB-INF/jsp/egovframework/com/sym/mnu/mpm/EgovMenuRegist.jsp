...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#popupProgrmFileNm').click(function (e) {
            ...
            var $dialog = $('<div></div>')
            .html('<iframe style="border: 0px; " src="' + page + '" width="100%" height="100%" title="프로그램리스트"></iframe>')
            .dialog({
            	autoOpen: false,
                modal: true,
                width: 550,
        ...
        $('#popupUpperMenuId').click(function (e) {
            ...
            .html('<iframe style="border: 0px; " src="' + page + '" width="100%" height="100%" title="메뉴리스트"></iframe>')
            .dialog({
            	autoOpen: false,
                modal: true,
                width: 610,
