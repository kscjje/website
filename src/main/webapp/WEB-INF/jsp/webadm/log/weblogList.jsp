						...
						<div class="col-4">
		              	...
		              	<div class="col-2">
		              			<select name="searchCondition" title="검색범위"  class="form-control">
									<option value="1"  <c:if test="${searchVO.searchCondition == '1'}">selected="selected"</c:if> >요청자 ID</option>
								</select>
						</div>
	               ...
	               <table class="table table-hover text-nowrap">
	                  <thead>
	                    <tr>
							...
							<th>요청아이디  <span id="rqutstid" class="sort">▼</span></th>
							<th>메뉴명</th>
...
<c:forEach items="${list}" var="resultInfo" varStatus="status">
	                    <tr>
	                      	...
	                      	<td><fmt:formatDate value="${resultInfo.occrrncDe}" pattern="yyyy-MM-dd HH:mm"/></td>
							<td><c:out value='${resultInfo.requstId}'/></td>
							<td><c:out value='${resultInfo.menuNm}'/></td>

							<td><c:out value='${resultInfo.rqesterId}'/></td>
							<td><c:out value='${resultInfo.rqesterIp}'/></td>
              ...
              <div class="card-footer p-0">
              	<div class="pagination_2">
						<tags:AdminPaging pageInfo="${paginationInfo}" pageUrl="./weblogList?pageIndex="/>
				</div>
            </div>
