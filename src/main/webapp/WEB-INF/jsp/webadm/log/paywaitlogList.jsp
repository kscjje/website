						...
						<div class="col-4">
		              	...
		              	<div class="col-2">
		              			<select name="searchCondition" title="검색범위"  class="form-control">
									<option value="1"  <c:if test="${searchVO.searchCondition == '1'}">selected="selected"</c:if> >예약번호</option>
								</select>
						</div>
              ...
              <div class="card-body table-responsive p-0">
	               <table class="table table-hover text-nowrap">
	                  <thead>
	                    <tr>
	                      	<th>번호</th><!-- 번호 -->
							<th>결제대기마감시간  <span id="waittime" class="sort">▼</span></th>
...
<c:forEach items="${list}" var="resultInfo" varStatus="status">
	                    <tr>
	                      	...
	                      	<td>
	                      		<hisco:DateUtil datestr="${resultInfo.paywaitDatetime}" format="yyyy-MM-dd HH:mm"/>
	                      	</td>
							<td><c:out value='${resultInfo.logSeq}'/></td>
							<td><c:out value='${resultInfo.partName}'/></td>

							<td><c:out value='${resultInfo.rsvnNo}'/></td>
              ...
              <div class="card-footer p-0">
              	<div class="pagination_2">
						<tags:AdminPaging pageInfo="${paginationInfo}" pageUrl="./paywaitlogList?pageIndex="/>
				</div>
            </div>
