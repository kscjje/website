...
<!-- 제1조 -->
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td class="txt_left">노원수학문화관 자원봉사자운영규정/노원수학문화관 업무에 필요한 자원봉사자에 대한 관리용</td>
							...
							<ul class="dot_list2 ty mb30">
								<li class="dot">개인정보보호 책임자: 운영지원과 김동섭 042-601-7760, kimds21@korea.kr</li>
								<li class="dot">개인정보보호 담당자: 운영지원과 김정희 042-601-7860, kate22@korea.kr</li>
							...
							<p>이 개인정보처리방침은 2015. 7. 24.부터 적용됩니다.</p>
							<!-- //제 11조 -->
							<input type="hidden" id="dt" value="2015. 7. 24" />