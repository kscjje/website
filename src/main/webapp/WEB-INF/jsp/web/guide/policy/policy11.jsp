...
<!-- 제1조 -->
							...
							<ol class="mb30">
								<li>
									...
									<ol>
										<li class="num_p">(1) 홈페이지 회원 가입 및 관리<br> 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인 식별·인증, 회원자격 유지·관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정이용 방지, 만14세 미만 아동의 개인정보 처리시 법정대리인의 동의 여부 확인, 각종 고지·통지, 증명서발급 등 서비스 제공에 관련한 목적으로 개인정보를 처리합니다.</li>
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td class="txt_left">전국학생발명품경진대회수상자목록/수상확인</td>
											<td class="txt_left">이름,E-Mail, 생년월일, 기타수상등급</td>
											<td>영구</td>
										</tr>
										<tr>
											<td>2</td>
											<td class="txt_left">전국과학전람회수상자목록</td>
											<td class="txt_left">전국과학전람회 규칙/ 수상확인</td>
											<td class="txt_left">이름,E-Mail, 생년월일, 성명, 소속, 수상등급</td>
											<td>영구</td>
										</tr>
										<tr>
											<td>3</td>
											<td class="txt_left">과학교실강사명부</td>
											<td class="txt_left">공공기록물관리에 관한 법률시행령제26조1항/ 강사관리</td>
											<td class="txt_left">이름, 생년월일, 주소, 이메일, 전화, 자격, 학력, 경력</td>
											<td>3년</td>
										</tr>
										<tr>
											<td>4</td>
											<td class="txt_left">전국학생과학발명품경진대회심사위원</td>
											<td class="txt_left">전국학생과학발명품경진대회규정/발명품 심사</td>
											<td class="txt_left">이름, 소속, 전공</td>
											<td>5년</td>
										</tr>
										<tr>
											<td>5</td>
											<td class="txt_left">전국과학전람회심사위원명단</td>
											<td class="txt_left">전국과학전람회규칙/ 전람회 심사</td>
											<td class="txt_left">이름, 소속, 전공</td>
											<td>5년</td>
										</tr>
										<tr>
											...
											<td class="txt_left">공공기록물관리에관한 법률시행령제26조1항/ 과학교실 자원봉사자 관리 </td>
											<td class="txt_left">이름,E-Mail,집연락처,직장연락처,핸드폰(연락처)성명,주민번호,계좌번호,연락처</td>
											<td>3년</td>
										</tr>
										<tr>
											<td>7</td>
											<td class="txt_left">자원봉사자관리</td>
											<td class="txt_left">노원수학문화관 자원봉사자운영규정/관람 자원봉사자 관리</td>
											<td class="txt_left">이름, 생년월일, 주소, 연락처</td>
											<td>3년</td>
										</tr>
										<tr>
											<td>8</td>
											<td class="txt_left">회원목록DB</td>
											<td class="txt_left">노원수학문화관 회원제운영관리규정/회원제 운영</td>
											<td class="txt_left">이름, 집주소, E-Mail, 핸드폰(연락처), 생년월일</td>
											<td>3년</td>
										</tr>
									</tbody>
								</table>
							...
							<ol class="mb55">
								<li>
									...
									<div class="table3 mb15">
										<table>
											<caption>개인정보처리의 위탁을 설명하는 표입니다.-순번, 업무명, 업체명, 위탁기간, 업무내용</caption>
											<colgroup>
												<col style="width:5%">
												<col style="*">
												<col style="*">
											...
											<tbody>
												<tr>
													...
													<td>홈페이지 위탁사업</td>
													<td>(주)연무기술</td>
													<td>2016. 1. 1~12. 31.</td>
													<td>홈페이지 운영, 회원 전화응대</td>
												</tr>
												<tr>
													<td>2</td>
													<td>매표시스템 위탁사업</td>
							...
							<ol class="mb55">
								...
								<li>
									<p>4. 처리 정지요구<br>※ 노원수학문화관 회원의 개인정보 정정·삭제·탈퇴는 '로그인 – 마이페이지'에서 가능합니다.</p>
								</li>
								<li>
								...
								<li>
									<p>11. 정보주체는 노원수학문화관의 열람청구 접수·처리부서(하단, 제9조 개인정보보호(분야별)책임자 및 담당자 연락처 참조) 이외에 행정자치부의 ‘개인정보보호 종합지원포털(<a href="http://www.privacy.go.kr" target="_blank">http://www.privacy.go.kr</a>)’을 통해 개인정보 열람청구를 하실 수 있습니다.</p>
								</li>
							</ol>
							<!-- //제5조 -->
							<!-- 제6조 -->
							...
							<ul class="dot_list2 ty mb30">
								<li class="dot">개인정보보호 책임자: 정보화팀장 김기영 042-601-7865, mig40@msip.go.kr</li>
								<li class="dot">개인정보보호 담당자: 정보화팀 김정희 042-601-7869, kate@msip.go.kr</li>
							...
							<p>이 개인정보처리방침은 2015. 1. 1.부터 적용됩니다.</p>
							<!-- //제 11조 -->
							<input type="hidden" id="dt" value="2015. 1. 1" />
