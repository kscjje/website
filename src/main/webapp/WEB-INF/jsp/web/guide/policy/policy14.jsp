...
<!-- 제1조 -->
							...
							<p class="txt mb30">1. 개인정보를 다음의 목적을 위해 처리합니다. 처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용 목적이 변경될 시에는 사전 동의를 구할 예정입니다.</p>
							<!-- table -->
							<div class="table3 mb55">
								<table>
									<caption>개인정보파일 현황표입니다.-순번, 파일명, 처리목적</caption>
									<colgroup>
										<col style="width:10%">
										<col style="*">
										<col style="width:30%">
									...
									<tbody>
										...
										<tr>
											<td>4</td>
											<td class="txt_left">교육및캠프수료자명부</td>
											<td>수료자 실적 관리</td>
										</tr>
										<tr>
											<td>5</td>
										...
										<tr>
											<td>6</td>
											<td class="txt_left">천체관측대회수상자</td>
											<td>수료자 실적관리</td>
										</tr>
										<tr>
											<td>7</td>
										...
										<tr>
											<td>12</td>
											<td class="txt_left">창의,인성 프로그램 참여자 명부</td>
											<td>참여 학생 관리</td>
										</tr>
									</tbody>
								</table>
							...
							<div class="table3 mb55">
								<table>
									...
									<tbody>
										...
										<tr>
											<td>4</td>
											<td class="txt_left">교육 및 캠프수료자명부</td>
											<td>3년</td>
										</tr>
										<tr>
											<td>5</td>
							...
							<ol class="mb30">
								...
								<li>
									<p>2. 국립중앙과학관에서 [http://www.hisco.co.kr/web/main] 에서만 제공됩니다.</p>
								</li>
								<li>
							...
							<!-- //제3조 -->
							<!-- 제4조 -->
							<h4 class="tit2">제4조(개인정보처리 위탁에 관한 사항(해당하는 경우에만 작성))</h4>
							<ol class="mb55">
								<li>
										...
										<table>
											...
											<tbody>
												...
												<tr>
													...
													<td>2013. 11(교육종료시점)</td>
													<td>창의수리과학교실</td>
													<td>창의수리과학교실<br> 교육운영</td>
												</tr>
												<tr>
													<td>3</td>
													<td>교육문화과</td>
													<td>emc 플랜</td>
													<td>2013. 8. 20(교육종료시점)</td>
													<td>여름방학STEAM과학캠프</td>
													<td>참여자 명찰 제작등</td>
												</tr>
												<tr>
													<td>4</td>
													<td>교육문화과</td>
													<td>(사)대한로봇교육문화협회 대전지회</td>
													<td>2013. 6. 25 ~ 11. 4(계약종료시점)</td>
													<td>2013 무한상상 방과후 로봇경진대회 운영 및 연출 대행</td>
													<td>로봇경진대회 참가신청 접수 및 대회 운영</td>
												</tr>
												<tr>
													<td>5</td>
													<td>스마트정보화팀</td>
													<td>(주)연무종합기술</td>
													<td>2013. 1. 1~12. 31</td>
													<td>홈페이지 유지보수</td>
													<td>대표 홈페이지 관리</td>
												</tr>
											</tbody>
							...
							<ol class="mb55">
								<li>
									<p>1. 정보주체는 국립중앙과학관에 대해 언제든지 다음과 같은 개인정보보호 관련 권리를 행사할 수 있습니다.</p>
									<ul class="sub_p_list">
								...
								<li>
									<p>2. 정보주체의 권리 행사는 개인정보보호법 시행규칙 별지 제8호 서식에 따라 서면, 전자우편, 모사전송(FAX) 등을 통해 할 수 있으며 국립중앙과학관은 이에 대해 지체 없이 조치하겠습니다. [별지 제8호 서식 다운로드] <a href="#" class="btn_ty_s_c2 down">다운로드</a></p>
								</li>
								<li>
									<p>3. 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 국립중앙과학관은 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.</p>
								</li>
								<li>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td class="txt_left">성명, 생년월인, 학교</td>
											<td class="txt_left">전화번호</td>
										</tr>
										<tr>
											<td>5</td>
										...
										<tr>
											<td>6</td>
											<td class="txt_left">천체관측대회수상자</td>
											<td class="txt_left">성명, 주민번호, 학력, 상훈</td>
											<td class="txt_left">성명, 주민번호</td>
											<td class="txt_left">학력, 상훈</td>
										</tr>
										<tr>
											<td>7</td>
										...
										<tr>
											<td>9</td>
											<td class="txt_left">큐레이터관리용</td>
											<td class="txt_left">성명, 주민번호, 전화번호, 이메일</td>
											<td class="txt_left">성명, 주민번호, 전화번호</td>
											<td class="txt_left">이메일</td>
										</tr>
										<tr>
											<td>10</td>
											<td class="txt_left">자원봉사자관리</td>
										...
										<tr>
											<td>12</td>
											<td class="txt_left">창의, 인성 프로그램 참여자 명부</td>
											<td class="txt_left">성명, 전화번호, 학교명, 주소</td>
											<td class="txt_left">성명, 학교명</td>
											<td class="txt_left">전화번호, 주소</td>
										</tr>
									</tbody>
								</table>
							</div>
							...
							<p class="txt">파일별 안전성 확보 조치 내용<br>국립중앙과학관은 개인정보보호법 제29조(안전조치의무)에 따라 다음과 같이 안전성 확보에 필요한 기술적, 관리적 및 물리적 조치를 하고 있습니다.</p>
							...
							<div class="ex_txt mb15">
								<p><i><img src="<%=strContext%>/images/sub/ico_notice03.png" alt="유의사항아이콘"></i> 개인정보주체는 개인정보침해로 인한 구제를 받기 위하여 한국인터넷진흥원 개인정보침해 신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다.<br> ※ 개인정보 침해신고 센터 : 국번없이 118번</p>
							</div>
							<!-- //제9조 -->
							<!-- 제 10조 -->
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>윤용현</td>
											<td>채대명<br>박상욱</td>
											<td>042-601-7739<br>042-601-7734</td>
											<td>goodresa@msip.go.kr<br>b14232@msip.go.kr</td>
										</tr>
										<tr>
											<td>5</td>
											<td>과학교실강사출근명부</td>
							...
							<p>이 개인정보처리방침은 2013. 7. 29.부터 적용됩니다.</p>
							<!-- //제 11조 -->
							<input type="hidden" id="dt" value="2013. 7. 29" />