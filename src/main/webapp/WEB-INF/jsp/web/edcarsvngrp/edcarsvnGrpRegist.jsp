										...
										<li>
											<div class="info">
												...
												<div class="numcontrol">
													...
													<input id="personCnt" name="edcVistnmpr" class="count" value="2" type="text" autocomplete="false" title="참여 인원수 입력">
...
<script type="text/javascript">
	...
	function fn_next() {
		if (fn_personcnt_check()) {
			$('#eduSaveForm').attr("action" , "./edcarsvnGrpRegInput");
			$("#eduSaveForm").submit();
		}
	}
	...
	function fn_cnt_change(itemCd, index, cnt, obj) {
		...
		var edc_Grp_Maxcnt = "${detailVO.edcGrpMaxcnt}";
		var edc_Grp_Mincnt = "${detailVO.edcGrpMincnt}";
