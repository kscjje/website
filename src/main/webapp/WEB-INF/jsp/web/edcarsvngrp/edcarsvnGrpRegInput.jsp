									...
									<table>
										...
										<tbody>
											<c:if test="${detailVO.edcProgmType eq '1001'}">
												...
												<tr>
													<th scope="row"><strong class="red">* </strong><label for="edcRsvnfmEtc">학년</label></th>
													<td>
...
<form>
	...
	<script type="text/javascript">
		...
		function fn_reserve_save() {
			...
			if (flag && emailFlag) {
				////$('body').showLoading();
				fn_ajaxEduOnly("./edcarsvnGrpRegSave", $("#eduSaveForm"), fn_rsvnsave_callback);
		...
		function fn_rsvnsave_callback(data) {
			...
			if (data.RESULT.EXE_YN == 'Y') {
				...
				$('#eduSaveForm').attr("action" , "./edcarsvnGrpRegEnd");
				$("#eduSaveForm").submit();
