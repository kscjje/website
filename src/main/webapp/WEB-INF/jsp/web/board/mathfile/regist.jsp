...
<script>
	...
	function fn_egov_regist_article() {
		...
		var varCaptcha = $("#captcha").val().trim();
		$("#captcha").val(varCaptcha);	
					...
					<tbody>
						<tr>
							...
							<td class="b">
								...
								<label for="secretAt1"><input type="radio" class="radio" id="secretAt1" name="secretAt" value="Y" onclick="fnSecretAt(1);" checked="" /><em></em>&nbsp;비공개</label>
								&nbsp;&nbsp;&nbsp;
								<label for="secretAt2"><input type="radio" class="radio" id="secretAt2" name="secretAt" value="N" onclick="fnSecretAt(2);" /><em></em>&nbsp;공개</label>							
