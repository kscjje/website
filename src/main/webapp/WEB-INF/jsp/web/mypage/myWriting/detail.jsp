...
<main class="content" id="content">
	...
	<div class="pageTit">
		<div class="pageTit-inner">
			<div class="pageTit-wrap">
				<h3 class="pageTit-title"><c:out value="${result.bbsId eq 'freeboard'?'자유게시판' : '묻고 답하기'}"/></h3>
				<ul class="pageTit-list">
					...
					<li class="pageTit-item">
						<a href="javascript:void(0)" title="이동" class="pageTit-link"><c:out value="${result.bbsId eq 'freeboard'?'자유게시판' : '묻고 답하기'}"/></a>
					</li>
				</ul>
			</div>
		</div>
	...
	<div class="sub">
					...
					<div class="detail-head">
						...
						<div class="detail-desc">
							...
							<div class="desc-right">
								<span>
									<img src="/web/resources/images/sub/ico_article_05.png" alt="아이콘"><fmt:formatDate value="${result.frstRegisterPnttm}" pattern="yyyy-MM-dd"/>
								</span>
								<span>
									<img src="/web/resources/images/sub/ico_article_07.png" alt="아이콘"><c:out value="${result.inqireCo}"/>
								</span>
                  			</div>
						</div>
					</div>
		...
		<div class="badge-btn">
			<a href="../myWritingList" class="black">목록</a>
			<c:if test="${commandMap.userInfo.id eq result.ntcrId}">
				<a href="./updt?nttId=<c:out value="${result.nttId}"/>" class="green">수정</a>
	...
	if (confirm("삭제하시겠습니까?")) {
		...
		$.ajax({
			...
			success : function(data) {
				...
				alert(obj.msg);
				if(obj.result == true){
					top.location.href="../myWritingList";
				}
			}
