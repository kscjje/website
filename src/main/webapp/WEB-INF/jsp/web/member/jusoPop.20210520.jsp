...
<%
 /**
  * @Class Name : jusoPop.jsp
  * @Description : JUSO.GO.KR 연계
  * @Modification Information
  * @
  * @  수정일             수정자               수정내용
  * @ -------    --------    ---------------------------
  * @ 2021.05.20   전영석              최초 생성
  *
  *  @author 전영석
  *  @since 2021.05.20
  *  @version 1.0
...
function init() {
	...
	var confmKey = "devU01TX0FVVEgyMDIxMDUyMDE5MjU0MTExMTE4NDg=";
	...
	if (inputYn != "Y") {
		...
		/** API 서비스 제공항목 확대 (2017.02) **/
		opener.fn_jusoCallBack("<%=roadFullAddr%>","<%=roadAddrPart1%>","<%=addrDetail%>", "<%=roadAddrPart2%>","<%=engAddr%>"
